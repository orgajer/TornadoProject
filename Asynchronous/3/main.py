...
# Version: 0.1
# Author: Song Huang <huangxiaohen2738@gmail.com> Comment By xiashuangxi
# License: Copyright(c) 2015 Song.Huang
# Summary: 
#          通过前端调用一个ajax请求，但是服务暂时不返回信息，并且把回调函数存储到callbacks中
#          当有用户来请求时，回调所有callbacks中的函数，并且再次通过前端来做长连接请求
#          两个关键点，一个是异步，另一个是回调函数保存
